...
export default async function PhimLePage({ searchParams }: PageProps) {
  const params = await searchParams;
  const page = parseInt(params.page || "1", 10);
  const moviesData = await getPhimLe(page, 30);
